...
import { Menu, Bell, Sun, Settings, MoonStar } from "lucide-react";
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center  gap-5">
            ...
            <button onClick={toggleDarkmode}>
              {isDarkMode ? 
                (<Sun className="cursor-pointer text-gray-500" size={24}></Sun>)
                  :
                (<MoonStar className="cursor-pointer text-gray-500" size={24}></MoonStar >)}
            </button>
          </div>
          <div className="relative">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="font-semibold">Junaid Ahmed</span>
          </div>
        </div>
        <Link href="">
          <Settings
